...
export function ModuleInfo({ moduleInfo }: ModuleInfoProps) {
  return (
    <div class="space-y-6">
      <div>
        <h3 class="text-xl font-medium text-light-textMuted dark:text-dark-textMuted mb-4">
        ...
        {moduleInfo ? (
          <div class="bg-light-surface2 dark:bg-dark-surface2 rounded-lg p-4 border border-light-surface3 dark:border-dark-surface3">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                <h4 class="font-medium text-light-textMuted dark:text-dark-textMuted mb-2">
                  Module Details
                </h4>
                <div class="space-y-1 text-sm">
                  <div>
                    <span class="text-light-textDim dark:text-dark-textDim">Name:</span>{' '}
                    {moduleInfo.name}
                  </div>
                  <div>
                    <span class="text-light-textDim dark:text-dark-textDim">Size:</span>{' '}
          ...
          <table class="w-full border-collapse">
            <thead>
              <tr class="bg-light-surface2 dark:bg-dark-surface2">
                <th class="text-left p-3 font-medium border-b border-light-surface3 dark:border-dark-surface3">
                  Feature
                </th>
                <th class="text-left p-3 font-medium border-b border-light-surface3 dark:border-dark-surface3">
                  Status
            ...
            <tbody>
              {WASI_FEATURES.map((feature, idx) => (
                <tr key={idx}>
                  <td class="p-3 border-b border-light-surface3 dark:border-dark-surface3 font-medium">
                    {feature.name}
                  </td>
                  <td
