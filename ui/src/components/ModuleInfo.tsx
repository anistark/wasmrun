...
function InspectionCard({ moduleInfo }: { moduleInfo: WasmModuleInfo | null }) {
    ...
    <div class="bg-light-surface2 dark:bg-dark-surface2 rounded-xl p-6 border border-light-surface3 dark:border-dark-surface3 h-full">
      ...
      <div class="space-y-4">
        <div class="grid grid-cols-2 gap-4 text-center">
          <div class="p-3 bg-light-surface3 dark:bg-dark-surface3 rounded-lg">
            <div class="text-lg font-bold text-light-textPrimary dark:text-dark-textPrimary">
          ...
          <div class="p-3 bg-light-surface3 dark:bg-dark-surface3 rounded-lg">
            ...
            <div class="text-xs text-light-textDim dark:text-dark-textDim">WASM Version</div>
          </div>
        </div>

        <div class="space-y-2">
          <div class="flex items-center justify-between text-sm">
            <span class="text-light-textDim dark:text-dark-textDim">Status</span>
            <span
              class={`px-2 py-1 rounded-full text-xs font-medium ${
                inspection.isValid
                  ? 'bg-green-100 dark:bg-green-900/20 text-green-700 dark:text-green-300'
        ...
        <div>
          <h4 class="text-sm font-medium text-light-textPrimary dark:text-dark-textPrimary mb-2">
            Key Sections
          </h4>
          <div class="max-h-32 overflow-y-auto space-y-1">
            {inspection.sections.slice(0, 5).map((section, idx) => (
              <div
                key={idx}
        ...
        {inspection.warnings.length > 0 && (
          <div class="p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
            ...
            <div class="text-xs text-yellow-600 dark:text-yellow-400">{inspection.warnings[0]}</div>
          </div>
        )}
      </div>
    </div>
  ...
  return (
    <div class="p-6 space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 auto-rows-fr">
        ...
        {/* Binary Analysis - New, spans 2 columns on medium+ screens */}
        <div class="md:col-span-2">
          <InspectionCard moduleInfo={moduleInfo} />
        </div>

        {/* WASI Support with tabs - spans remaining columns */}
